...
export default function NurturePage() {
  ...
  return (
    <div className="px-8 py-6 max-w-[1400px] mx-auto space-y-6">
      <div>
        <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Pillar 4 — Lead Capture & Nurture</p>
                ...
                <div key={seq.id} className="p-4 border border-slate-200 rounded-xl bg-white shadow-xs space-y-2">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500">{seq.emailsCount} Emails • Target: {seq.targetStage}</p>
                    </div>
