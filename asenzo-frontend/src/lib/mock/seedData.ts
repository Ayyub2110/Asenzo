...
export const generateDemoData = () => {
    ...
    historicalLeadData.forEach((ld, i) => {
        ...
        const lead: Lead & { isDemo?: boolean } = {
            ...
            lifecycleStage: ld.won ? "CONVERTED" : (ld.callShowed ? "CALL_SHOWED" : "NEW"),
    ...
    currentMonthLeads.forEach((ld, i) => {
        ...
        const lead: Lead & { isDemo?: boolean } = {
            ...
            qualificationStatus: "QUALIFIED",
            lifecycleStage: ld.won ? "CONVERTED" : (ld.showed ? "CALL_SHOWED" : "NEW"),
    ...
    for (let i = 0; i < 48; i++) {
        ...
        conversionLeads.push({
            ...
            lifecycleStage: qualStatus === "QUALIFIED" ? "QUALIFIED" : "NEW",
