...
<nav className="fixed left-4 top-4 bottom-4 w-[260px] rounded-xl bg-[#0B0C0E] shadow-[0px_4px_20px_rgba(0,0,0,0.4)] flex flex-col p-gutter space-y-unit z-50 hidden md:flex">

<div className="px-4 py-6 mb-4">
<h1 className="font-display-lg text-display-lg text-white tracking-tight">ASENZO</h1>
<p className="font-label-caps text-label-caps text-gray-400 mt-1 uppercase tracking-widest">Growth OS</p>
</div>

<div className="flex-1 space-y-2">
<a className="flex items-center px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all rounded-lg scale-95 duration-200" href="#">
<span className="material-symbols-outlined mr-3" style="font-variation-settings: 'FILL' 0;">rocket_launch</span>
<span className="font-body-sm text-body-sm font-medium">Engine</span>
</a>
<a className="flex items-center px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all rounded-lg scale-95 duration-200" href="#">
<span className="material-symbols-outlined mr-3" style="font-variation-settings: 'FILL' 0;">trending_up</span>
<span className="font-body-sm text-body-sm font-medium">Growth</span>
</a>
<a className="flex items-center px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all rounded-lg scale-95 duration-200" href="#">
<span className="material-symbols-outlined mr-3" style="font-variation-settings: 'FILL' 0;">insights</span>
<span className="font-body-sm text-body-sm font-medium">Analytics</span>
</a>
<a className="flex items-center px-4 py-3 bg-white text-black rounded-lg font-semibold scale-95 duration-200 shadow-sm" href="#">
<span className="material-symbols-outlined mr-3" style="font-variation-settings: 'FILL' 1;">calendar_month</span>
<span className="font-body-sm text-body-sm font-medium">Calendar</span>
</a>
<a className="flex items-center px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all rounded-lg scale-95 duration-200" href="#">
<span className="material-symbols-outlined mr-3" style="font-variation-settings: 'FILL' 0;">hub</span>
<span className="font-body-sm text-body-sm font-medium">Network</span>
</a>
<a className="flex items-center px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all rounded-lg scale-95 duration-200" href="#">
<span className="material-symbols-outlined mr-3" style="font-variation-settings: 'FILL' 0;">account_tree</span>
<span className="font-body-sm text-body-sm font-medium">Resources</span>
</a>
<a className="flex items-center px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all rounded-lg scale-95 duration-200" href="#">
<span className="material-symbols-outlined mr-3" style="font-variation-settings: 'FILL' 0;">settings</span>
<span className="font-body-sm text-body-sm font-medium">Settings</span>
</a>
</div>

<div className="mt-auto pt-6 border-t border-gray-800/50 space-y-2">
<a className="flex items-center px-4 py-2 text-gray-400 hover:text-white transition-all scale-95 duration-200" href="#">
<span className="material-symbols-outlined mr-3 text-sm" style="font-variation-settings: 'FILL' 0;">help_outline</span>
<span className="font-body-sm text-body-sm">Support</span>
</a>
<a className="flex items-center px-4 py-2 text-gray-400 hover:text-white transition-all scale-95 duration-200" href="#">
<span className="material-symbols-outlined mr-3 text-sm" style="font-variation-settings: 'FILL' 0;">person</span>
<span className="font-body-sm text-body-sm">Account</span>
</a>
<button className="w-full mt-4 bg-gray-800 text-white rounded-lg py-3 font-body-sm text-body-sm font-medium hover:bg-gray-700 transition-colors">
                Upgrade Plan
            </button>
</div>
</nav>

<main className="flex-1 ml-sidebar-width flex flex-col min-h-screen max-w-[1440px] mx-auto w-full">
