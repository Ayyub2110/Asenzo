...
<nav className="fixed left-4 top-4 bottom-4 w-sidebar-width rounded-xl bg-primary-container dark:bg-primary-container shadow-lg flex flex-col h-[calc(100vh-32px)] p-4 justify-between z-50">
<div>

<div className="flex items-center gap-3 px-2 mb-8">
<div className="w-8 h-8 rounded-lg bg-surface-container-lowest flex items-center justify-center shrink-0">
<span className="material-symbols-outlined text-primary" style="font-variation-settings: 'FILL' 1;">dashboard</span>
</div>
<div>
<h1 className="font-headline-md text-headline-md font-bold text-on-primary tracking-tight">ASENZO OS</h1>
<p className="font-label-muted text-label-muted text-on-primary-container">v1.0.4</p>
</div>
</div>

<div className="space-y-1">
<p className="px-4 py-2 font-label-caps text-label-caps text-on-primary-container/60 uppercase tracking-wider">Growth Engines</p>
<a className="text-on-primary-container opacity-70 hover:opacity-100 flex items-center px-4 py-3 mx-2 hover:bg-on-surface-variant/10 transition-all duration-200 rounded-lg group" href="#">
<span className="material-symbols-outlined mr-3 text-[20px] group-active:scale-90 transition-transform">dashboard</span>
<span className="font-body-sm text-body-sm font-medium">Overview</span>
</a>
<a className="text-on-primary-container opacity-70 hover:opacity-100 flex items-center px-4 py-3 mx-2 hover:bg-on-surface-variant/10 transition-all duration-200 rounded-lg group" href="#">
<span className="material-symbols-outlined mr-3 text-[20px] group-active:scale-90 transition-transform">visibility</span>
<span className="font-body-sm text-body-sm font-medium">Attention OS</span>
</a>
<a className="text-on-primary-container opacity-70 hover:opacity-100 flex items-center px-4 py-3 mx-2 hover:bg-on-surface-variant/10 transition-all duration-200 rounded-lg group" href="#">
<span className="material-symbols-outlined mr-3 text-[20px] group-active:scale-90 transition-transform">shopping_cart</span>
<span className="font-body-sm text-body-sm font-medium">Conversion OS</span>
</a>
<a className="text-on-primary-container opacity-70 hover:opacity-100 flex items-center px-4 py-3 mx-2 hover:bg-on-surface-variant/10 transition-all duration-200 rounded-lg group" href="#">
<span className="material-symbols-outlined mr-3 text-[20px] group-active:scale-90 transition-transform">local_shipping</span>
<span className="font-body-sm text-body-sm font-medium">Delivery OS</span>
</a>

<a className="bg-surface text-on-surface rounded-lg font-bold flex items-center px-4 py-3 mx-2 hover:bg-surface/90 transition-all duration-200 group relative shadow-[0px_4px_20px_rgba(0,0,0,0.04)]" href="#">
<div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-primary rounded-r-full"></div>
<span className="material-symbols-outlined mr-3 text-[20px] group-active:scale-90 transition-transform" style="font-variation-settings: 'FILL' 1;">insights</span>
<span className="font-body-sm text-body-sm">Intelligence OS</span>
</a>
<a className="text-on-primary-container opacity-70 hover:opacity-100 flex items-center px-4 py-3 mx-2 hover:bg-on-surface-variant/10 transition-all duration-200 rounded-lg group" href="#">
<span className="material-symbols-outlined mr-3 text-[20px] group-active:scale-90 transition-transform">settings_applications</span>
<span className="font-body-sm text-body-sm font-medium">Operator OS</span>
</a>
<a className="text-on-primary-container opacity-70 hover:opacity-100 flex items-center px-4 py-3 mx-2 hover:bg-on-surface-variant/10 transition-all duration-200 rounded-lg group" href="#">
<span className="material-symbols-outlined mr-3 text-[20px] group-active:scale-90 transition-transform">calendar_today</span>
<span className="font-body-sm text-body-sm font-medium">Growth Calendar</span>
</a>
</div>
</div>

<div className="mt-auto space-y-4 px-2">
<div className="bg-surface/5 rounded-xl p-4 border border-outline-variant/10">
<div className="flex items-center gap-2 mb-2">
<span className="material-symbols-outlined text-surface-tint text-[18px]">bolt</span>
<span className="font-label-muted text-label-muted text-on-primary-container">Founder Independence Score</span>
</div>
<div className="flex items-end gap-1">
<span className="font-headline-sm text-headline-sm text-surface">84</span>
<span className="font-label-muted text-label-muted text-on-primary-container/60 mb-0.5">/100</span>
</div>
<div className="w-full bg-primary-fixed-variant/30 h-1.5 rounded-full mt-2 overflow-hidden">
<div className="bg-surface h-full rounded-full" style="width: 84%"></div>
</div>
</div>
<button className="w-full bg-surface text-primary font-body-sm text-body-sm font-semibold py-2.5 rounded-lg hover:bg-surface-container-highest transition-colors flex items-center justify-center gap-2">
...
<main className="flex-1 ml-[292px] flex flex-col h-screen relative">
